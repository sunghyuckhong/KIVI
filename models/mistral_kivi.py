    ...
    def forward(
        ...
        **kwargs,
        ...
        if past_key_value is not None:
            ...
            # Pass None for attention_mask to use flash_attn_func directly
            # (avoids _upad_input which causes OOM with GQA repeat_kv).
            # flash_attn handles GQA natively so no need for repeat_kv.
